...
_IMPORT_ONCE = False
_CORE_MODULES = (
    "tico.experimental.quantization.wrapq.wrappers.quant_elementwise",
    "tico.experimental.quantization.wrapq.wrappers.nn.quant_layernorm",
    "tico.experimental.quantization.wrapq.wrappers.nn.quant_linear",
    "tico.experimental.quantization.wrapq.wrappers.nn.quant_silu",
    # llama
    "tico.experimental.quantization.wrapq.wrappers.llama.quant_attn",
    "tico.experimental.quantization.wrapq.wrappers.llama.quant_decoder_layer",
    "tico.experimental.quantization.wrapq.wrappers.llama.quant_mlp",
    # fairseq
    "tico.experimental.quantization.wrapq.wrappers.fairseq.quant_decoder_layer",
    "tico.experimental.quantization.wrapq.wrappers.fairseq.quant_encoder",
    "tico.experimental.quantization.wrapq.wrappers.fairseq.quant_encoder_layer",
    "tico.experimental.quantization.wrapq.wrappers.fairseq.quant_mha",
