...
"""Smoke tests migrated from the Conv3d quantization example."""
...
class TestNNConv3dExample(unittest.TestCase):
    """Exercise the old Conv3d PTQ example with a tiny patch-embed-like layer."""

    def test_prepare_convert_conv3d_flow_matches_example(self):
        """Quantize Conv3d and validate output shape and finiteness."""
        ...
        calibration_data = [torch.randn(1, 3, 2, 8, 8) for _ in range(3)]
        with torch.no_grad():
